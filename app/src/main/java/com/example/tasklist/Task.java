...
public class Task {
    ...
    public long getTaskId (){return listId;}
    ...
    public long getCompletedDateMillis() {return Long.parseLong(completedDate);}

    public void setCompletedDate (String date_completed) {this.completedDate = date_completed;}

    public void setCompletedDate (long millis) {this.completedDate = Long.toString(millis);}
